...
let UploadSymbols = class UploadSymbols extends commandline_1.AppCommand {
    ...
    validateParameters() {
        ...
        if (_.isNil(this.symbolsPath) && _.isNil(this.xcarchivePath) && _.isNil(this.breakpadPath)) {
            throw commandline_2.failure(commandline_2.ErrorCodes.InvalidParameter, "specify either '--symbol', '--xcarchive', or '--breakpad' switch");
        }
            ...
            throw commandline_2.failure(commandline_2.ErrorCodes.InvalidParameter, "'--symbol' and '--breakpad' switches are mutually exclusive");
        }
        else if (!_.isNil(this.xcarchivePath) && !_.isNil(this.breakpadPath)) {
            throw commandline_2.failure(commandline_2.ErrorCodes.InvalidParameter, "'--xcarchive' and '--breakpad' switches are mutually exclusive");
        }
...
__decorate([
    commandline_3.help("Path to a zip file containing Breakpad symbols."),
