...
let WizardTestCommand = class WizardTestCommand extends commandline_1.AppCommand {
    ...
    run(client, portalBaseUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const getAppOS = client.apps.get(app.ownerName, app.appName);
    ...
    getApps(client) {
        return __awaiter(this, void 0, void 0, function* () {
            const apps = yield interaction_1.out.progress("Getting list of apps...", apis_1.clientCall((cb) => client.apps.list(cb)));
