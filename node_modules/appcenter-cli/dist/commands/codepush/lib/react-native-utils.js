...
function getReactNativeProjectAppVersion(versionSearchParams, projectRoot) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        interaction_1.out.text(chalk_1.default.cyan(`Detecting ${versionSearchParams.os} app version:\n`));
...
function runHermesEmitBinaryCommand(bundleName, outputFolder, sourcemapOutput, extraHermesFlags) {
    ...
    const hermesProcess = exports.spawn(path.join("node_modules", "hermesvm", getHermesOSBin(), "hermes"), hermesArgs);
    interaction_1.out.text(`${path.join("node_modules", "hermesvm", getHermesOSBin(), "hermes")} ${hermesArgs.join(" ")}`);
    return new Promise((resolve, reject) => {
