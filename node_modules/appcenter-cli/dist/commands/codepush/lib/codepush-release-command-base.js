        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error.response && error.response.statusCode === 409 && this.disableDuplicateReleaseError) {
                    ...
                    console.warn(chalk_1.default.yellow("[Warning] " + error.response.body));
                    return commandline_1.success();
                }
                else {
    ...
    validate(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!Number.isSafeInteger(this.rollout) || !validation_utils_1.isValidRollout(this.rollout)) {
                return commandline_1.failure(commandline_1.ErrorCodes.InvalidParameter, `Rollout value should be integer value between ${chalk_1.default.bold("0")} or ${chalk_1.default.bold("100")}.`);
            }
...
__decorate([
    commandline_1.help("Specifies the location of a RSA private key to sign the release with." + chalk_1.default.yellow("NOTICE:") + " use it for react native applications only, client SDK on other platforms will be ignoring signature verification for now!"),
