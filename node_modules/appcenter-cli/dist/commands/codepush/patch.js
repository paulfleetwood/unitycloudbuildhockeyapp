    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.rollout != null && (!Number.isSafeInteger(rollout) || !validation_utils_1.isValidRollout(rollout))) {
                return commandline_1.failure(commandline_1.ErrorCodes.Exception, `Rollout value should be integer value between ${chalk_1.default.bold("0")} or ${chalk_1.default.bold("100")}.`);
            }
            ...
            try {
                ...
                if (httpRequest.response.statusCode === 204) {
                    interaction_1.out.text(`No update for the ${chalk_1.default.bold(this.releaseLabel)} of ${this.identifier} app's ${chalk_1.default.bold(this.deploymentName)} deployment`);
                }
                else {
                    interaction_1.out.text(`Successfully updated the ${chalk_1.default.bold(release.label)} of ${this.identifier} app's ${chalk_1.default.bold(this.deploymentName)} deployment`);
                }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (error.statusCode === 404) {
                    ...
                    const deploymentNotExistErrorMsg = `The deployment ${chalk_1.default.bold(this.deploymentName)} does not exist.`;
            ...
            if (releases && releases.length > 0) {
                ...
                throw commandline_1.failure(commandline_1.ErrorCodes.NotFound, `Failed to find any release to patch for ${this.identifier} app's ${chalk_1.default.bold(this.deploymentName)} deployment`);
            }
        });
    }
};
