...
let CodePushDeploymentListListCommand = class CodePushDeploymentListListCommand extends commandline_1.AppCommand {
    ...
    generateColoredTableTitles(tableTitles) {
        return tableTitles.map((title) => chalk_1.default.cyan(title));
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield Promise.all(deployments.map((deployment) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (deployment.latestRelease) {
                    ...
                    metadataString = chalk_1.default.magenta("No updates released");
                    metricsString = chalk_1.default.magenta("No installs recorded");
                }
    ...
    generateMetricsString(releaseMetrics, releasesTotalActive) {
        if (releaseMetrics) {
            ...
            metricsString += chalk_1.default.green("Active: ") + percentString + ` (${releaseMetrics.active} of ${releasesTotalActive})\n`;
            if (releaseMetrics.installed != null) {
                metricsString += chalk_1.default.green("Installed: ") + releaseMetrics.installed;
            }
            ...
            return chalk_1.default.magenta("No installs recorded");
        }
    }
    generateMetadataString(release) {
        let metadataString = "";
        const lineFeed = "\n";
        metadataString += chalk_1.default.green("Label: ") + release.label + lineFeed;
        metadataString += chalk_1.default.green("App Version: ") + release.targetBinaryRange + lineFeed;
        metadataString += chalk_1.default.green("Mandatory: ") + (release.isMandatory ? "Yes" : "No") + lineFeed;
        metadataString += chalk_1.default.green("Release Time: ") + date_helper_1.formatDate(release.uploadTime) + lineFeed;
        metadataString += chalk_1.default.green("Released By: ") + release.releasedBy;
