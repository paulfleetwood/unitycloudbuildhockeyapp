...
let CodePushDeploymentHistoryCommand = class CodePushDeploymentHistoryCommand extends commandline_1.AppCommand {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                tableTitles = tableTitles.map((title) => chalk_1.default.cyan(title));
    ...
    generateReleaseAdditionalInfoString(release) {
        ...
        return (additionalInfo) ? "\n" + chalk_1.default.magenta(additionalInfo) : "";
    }
    generateReleaseMetricsString(release, metrics, releasesTotalActive) {
        ...
        if (releaseMetrics) {
            ...
            if (releaseMetrics.installed != null) {
                metricsString += "\n" + chalk_1.default.green("Installed: ") + releaseMetrics.installed;
            ...
            if (releaseMetrics.failed > 0) {
                metricsString += "\n" + chalk_1.default.green("Rollbacks: ") + chalk_1.default.red(releaseMetrics.failed.toString());
            }
        }
        else {
        ...
        if (release.rollout != null && release.rollout !== 100) {
            metricsString += "\n" + chalk_1.default.green("Rollout: ") + release.rollout + "%";
        }
        if (release.isDisabled) {
            metricsString += "\n" + chalk_1.default.green("Disabled: ") + "Yes";
        }
