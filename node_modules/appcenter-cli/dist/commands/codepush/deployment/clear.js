    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield interaction_1.out.progress(`Clearing release history for deployment ${this.deploymentName}...`, apis_1.clientRequest((cb) => client.codePushDeploymentReleases.deleteMethod(this.deploymentName, app.ownerName, app.appName, cb)));
            }
            catch (error) {
