    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                interaction_1.out.text(`Deployment ${chalk_1.default.bold(deployment.name)} has been created for ${this.identifier} with key ${deployment.key}`);
                ...
                if (error.statusCode === 404) {
                    ...
                    const deploymentExistErrorMsg = `A deployment named ${chalk_1.default.bold(this.newDeploymentName)} already exists.`;
