...
let OrgShowCommand = class OrgShowCommand extends commandline_1.Command {
    run(client, portalBaseUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ], { displayName: organizationDetails.displayName, url: portal_helper_1.getPortalOrgLink(portalBaseUrl, this.name), admins, appsCount: apps.length, collaboratorsCount: users.length, origin: organizationDetails.origin });
    ...
    getOrgApps(client, organization) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const httpResponse = yield apis_1.clientRequest((cb) => client.apps.listForOrg(organization, cb));
