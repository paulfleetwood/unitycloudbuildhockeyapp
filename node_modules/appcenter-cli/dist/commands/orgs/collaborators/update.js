...
let OrgCollaboratorsUpdateCommand = class OrgCollaboratorsUpdateCommand extends commandline_1.Command {
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [collaboratorsToAdd, collaboratorsToDelete, collaboratorsToMakeAdmins, adminsToMakeCollaborators, usersInvitedToOrg, usersJoinedOrg] = yield interaction_1.out.progress("Loading prerequisites...", Promise.all([collaboratorsToAddPromise, collaboratorsToDeletePromise, collaboratorsToMakeAdminsPromise, adminsToMakeCollaboratorsPromise, usersInvitedToOrgPromise, usersJoinedOrgPromise]));
    ...
    addCollaborators(client, collaborators, usersInvitedToOrg, usersJoinedOrg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(filteredCollaborators
                .map((collaborator) => limiter(() => usersInvitedToOrg.some((invited) => invited === collaborator) ? this.resendInvitationToUser(client, collaborator) : this.sendInvitationToUser(client, collaborator))));
