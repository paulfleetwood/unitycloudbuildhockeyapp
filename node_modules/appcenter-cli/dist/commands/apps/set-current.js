...
let SetCurrentAppCommand = class SetCurrentAppCommand extends commandline_1.Command {
    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!profile) {
                return commandline_1.failure(commandline_1.ErrorCodes.InvalidParameter, `Could not find a logged in profile, please note that this command is not compatible with the '--token' parameter or the token environment variable.`);
            }
