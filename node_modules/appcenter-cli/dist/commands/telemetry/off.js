...
let TelemetryOnCommand = class TelemetryOnCommand extends commandline_1.Command {
    ...
    runNoClient() {
        return __awaiter(this, void 0, void 0, function* () {
            yield profile_1.saveTelemetryOption(false);
            interaction_1.out.text(`${misc_1.scriptName} cli will not send telemetry with requests`);
            return commandline_1.success();
        });
    }
};
TelemetryOnCommand = __decorate([
    commandline_1.help("Turn off the sending of telemetry")
], TelemetryOnCommand);
