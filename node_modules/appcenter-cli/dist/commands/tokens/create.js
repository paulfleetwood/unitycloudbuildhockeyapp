...
let TokenCreateCommand = class TokenCreateCommand extends commandline_1.Command {
    constructor(args) {
        super(args);
    }
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createTokenResponse = yield interaction_1.out.progress("Creating token ...", apis_1.clientRequest((cb) => client.apiTokens.newMethod(tokenAttributes, cb)));
            ...
            if (statusCode >= 400) {
                switch (statusCode) {
                    ...
                    case 404:
                        return commandline_1.failure(commandline_1.ErrorCodes.NotLoggedIn, "user could not be found");
                }
            }
