    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (testersEmails.length) {
                ...
                interaction_1.out.text((obj) => `Successfully created the ${obj.distributionGroupName} distribution group`, { distributionGroupName: this.distributionGroup, testersAdded: [] });
            }
