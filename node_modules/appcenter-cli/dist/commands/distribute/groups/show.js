...
let ShowDistributionGroupCommand = class ShowDistributionGroupCommand extends commandline_1.AppCommand {
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const basicReleasesDetailsRequestResponse = apis_1.clientRequest((cb) => client.releases.listByDistributionGroup(this.distributionGroup, app.ownerName, app.appName, cb));
