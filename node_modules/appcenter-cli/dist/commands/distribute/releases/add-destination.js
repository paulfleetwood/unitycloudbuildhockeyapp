...
let AddDestinationCommand = class AddDestinationCommand extends commandline_1.AppCommand {
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            interaction_1.out.text(`Distribution of ${this.mandatory ? "mandatory " : ""}release ${this.releaseId} to ${this.destinationType} was successful ${this.silent ? "without" : "with"} notification`);
    ...
    addTesterToRelease(client, releaseId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (response.statusCode >= 200 && response.statusCode < 400) {
                ...
                throw commandline_1.failure(commandline_1.ErrorCodes.Exception, `Could not add ${this.destinationType} ${this.destination} to release ${releaseId}`);
            }
        });
    }
};
...
__decorate([
    commandline_1.help("Destination Type: " + ValidDestinationTypes.join(", ")),
...
__decorate([
    commandline_1.help("Destination: The name of the group or the email of a tester"),
...
AddDestinationCommand = __decorate([
    commandline_1.help("Distributes an existing release to an additional destination")
