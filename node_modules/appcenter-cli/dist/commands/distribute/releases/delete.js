    ...
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const httpResponse = yield interaction_1.out.progress(`Removing the release...`, apis_1.clientRequest((cb) => client.releases.deleteMethod(releaseId, app.ownerName, app.appName, cb)));
