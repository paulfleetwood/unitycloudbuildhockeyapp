        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (httpRequest.response.statusCode >= 400) {
                    return httpRequest.response.statusCode === 404 ? commandline_1.failure(commandline_1.ErrorCodes.InvalidParameter, `release ${this.releaseId} doesn't exist`) : commandline_1.failure(commandline_1.ErrorCodes.Exception, "failed to load release details");
                }
                else {
            ...
            try {
                ...
                const httpResponse = yield interaction_1.out.progress(`${state === "enabled" ? "Enabling" : "Disabling"} the release...`, apis_1.clientRequest((cb) => client.releases.updateDetails(releaseId, app.ownerName, app.appName, { enabled: state === "enabled" }, cb)));
