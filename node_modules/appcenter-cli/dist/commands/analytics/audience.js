...
let AudienceCommand = class AudienceCommand extends commandline_1.AppCommand {
    ...
    loadActiveUsersStatistics(statisticsObject, client, app, startDate, endDate, appVersion) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const httpRequest = yield apis_1.clientRequest((cb) => client.analytics.deviceCounts(startDate, app.ownerName, app.appName, {
                    end: endDate,
                    versions: appVersion
                }, cb));
                const result = httpRequest.result;
